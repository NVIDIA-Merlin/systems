...
def test_serve_tf_with_libtensorflow(tmpdir):
    ...
    # TODO: Figure out why the model signature picks up everything from the dataloader,
    # not just the columns it uses
    # TODO: Figure out why the outputs are wrong vs the schema
    # (why doesn't models provide an output schema?)
