...
class NVTabularServingExecutor(LocalExecutor):
    def __init__(self, device: str):
        self.device = device
        self.supports = Supports.CPU_DATAFRAME if device == "CPU" else Supports.GPU_DATAFRAME
    ...
    def transform(
        ...
        for node in nodes:
            ...
            transformed_data, kind = convert_format(transformed_data, kind, self.supports)
