...
Refer to the [Merlin Systems Example Notebooks](https://nvidia-merlin.github.io/systems/main/examples/index.html) for a notebook that serves a ranking models ensemble.
